...
/**
 * Right-hand properties panel: page geometry, the unit it is edited in, and
 * export.
 *
 * Geometry is stored in millimetres throughout; the unit here is purely a
 * display choice, converted on the way in and out. That keeps print sizing
 * exact no matter which unit the operator prefers.
 */
  ...
  return (
    <div className="space-y-6">
      <section className="space-y-3">
        <h2 className="text-sm font-medium">{t('page_props_heading')}</h2>
              ...
              return (
                <li key={preset.id}>
                  <button
                    ...
                    className={cn(
                      `
                        cursor-pointer rounded-md border px-2 py-1 text-[11px]
      ...
      <section className="space-y-2">
        <h2 className="text-sm font-medium">{t('export_heading')}</h2>
